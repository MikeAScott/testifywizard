...
public class SearchAction implements ISearchAction {
	 ...
	 * @throws AtestProjectException if search parameter is wrong
     */
	public List<Album> searchByAlbum(String searchQuery, boolean searchInMyAlbums, boolean searchInShared) throws AtestProjectException {
		Query query = searchQueryFactory.getQuery(SearchEntityEnum.ALBUM, user, searchInShared, searchInMyAlbums, searchQuery);
		if(null == query){
			throw new AtestProjectException(Constants.WRONG_SEARCH_PARAMETERS_ERROR);
		}
	 ...
	 * @throws AtestProjectException if search parameter is wrong
     */
	public List<Image> searchByImage(String searchQuery, boolean searchInMyAlbums, boolean searchInShared) throws AtestProjectException {
	 ...
	 * @throws AtestProjectException if search parameter is wrong
     */
	public List<User> searchByUsers(String searchQuery, boolean searchInMyAlbums, boolean searchInShared) throws AtestProjectException {
	 ...
	 * @throws AtestProjectException if search parameter is wrong
     */
	public List<MetaTag> searchByTags(String searchQuery, boolean searchInMyAlbums, boolean searchInShared) throws AtestProjectException {
	...
	public List<Shelf> searchByShelves(String searchQuery, boolean searchInMyAlbums,
			boolean searchInShared) throws AtestProjectException {
