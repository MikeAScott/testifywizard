...
public class SearchQueryFactory {
	 ...
	 * @throws AtestProjectException - in case of wrong search parameters
	 * @return query object, that dependent of type of searched entity and other parameters
	 */
	public Query getQuery(SearchEntityEnum entity, User user, boolean searchInShared, boolean searchInMy, String queryString) throws AtestProjectException{
		...
		default: throw new AtestProjectException(Constants.WRONG_SEARCH_PARAMETERS_ERROR);
		}
