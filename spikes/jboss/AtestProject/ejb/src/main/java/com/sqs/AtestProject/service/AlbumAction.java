...
public class AlbumAction implements IAlbumAction {
	 ...
	 */
	public void addAlbum(Album album) throws AtestProjectException {
		try {
			em.persist(album);
			//Add to shelf
	 ...
	 * @throws AtestProjectException
	 */
	public void deleteAlbum(Album album) throws AtestProjectException {
	 ...
	 * @throws AtestProjectException
	 */
	public void editAlbum(Album album) throws AtestProjectException {
		try {
			em.flush();
		} catch (Exception e) {
			throw new AtestProjectException(e.getMessage());
