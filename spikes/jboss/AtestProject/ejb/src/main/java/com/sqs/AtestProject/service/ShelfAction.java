...
public class ShelfAction implements IShelfAction {
     ...
     */
	public void addShelf(Shelf shelf) throws AtestProjectException {
		try{
			em.persist(shelf);
	 ...
	 * @throws AtestProjectException
     */
	public void deleteShelf(Shelf shelf) throws AtestProjectException {
		try{
	 ...
	 * @throws AtestProjectException
     */
	public void editShelf(Shelf shelf) throws AtestProjectException {
		try{
			em.flush();
		}
        catch(Exception e){
